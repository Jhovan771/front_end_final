...
import Sunny from "../../assets/Unit1/Middle.jpeg";
import found from "../../assets/Unit1/Jug.jpeg";
import thirsty from "../../assets/Unit1/Mug.jpeg";
import water from "../../assets/Unit1/Bug.jpeg";
import Lessonbar from "./Lessonbar";

const Lesson6 = () => {
  const [wordData] = useState(["Middle", "Jug ", "Mug", "Bug"]);
        ...
        <div className='class-section-wrapper'>
          ...
          <div className='class-section-content'>
            <div className='title-voice-changer-control'>
              <h2>A Jug in the Middle of a Rug</h2>
              <select
