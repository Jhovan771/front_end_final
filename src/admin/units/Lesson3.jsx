...
import Sunny from "../../assets/Unit1/funny.jpg";
import found from "../../assets/Unit1/like.jpg";
import thirsty from "../../assets/Unit1/yell.jpeg";
import water from "../../assets/Unit1/happy.jpg";
import Lessonbar from "./Lessonbar";

const Lesson3 = () => {
  const [wordData] = useState(["Funny", "Like", "Yell", "Happy"]);
