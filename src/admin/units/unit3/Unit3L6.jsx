...
import Sunny from "../../../assets/Unit1/Cooking.jpeg";
import found from "../../../assets/Unit1/Looking.jpeg";
import thirsty from "../../../assets/Unit1/Oyster.jpeg";
import water from "../../../assets/Unit1/Voice.jpeg";
import Lessonbar2 from "./Unit3-Lessonbar/Lessonbar3";

const Unit3L6 = () => {
  const [wordData] = useState(["Cooking", "Looking", "Oyster", "Voice"]);
        ...
        <div className='class-section-wrapper'>
          ...
          <div className='class-section-content'>
            <div className='title-voice-changer-control'>
              {/* wllplyd */}
              <h2>Roy and the Field of Soy</h2>
              <select
