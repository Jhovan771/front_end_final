...
import Sunny from "../../../assets/Unit1/Built.jpeg";
import found from "../../../assets/Unit1/Nailed.jpeg";
import thirsty from "../../../assets/Unit1/Boards.jpeg";
import water from "../../../assets/Unit1/Stand.jpeg";
import Lessonbar2 from "./Unit3-Lessonbar/Lessonbar3";

const Unit3L2 = () => {
  const [wordData] = useState(["Built", "Nailed", "Boards", "Stand"]);
        ...
        <div className='class-section-wrapper'>
          ...
          <div className='class-section-content'>
            <div className='title-voice-changer-control'>
              {/* wllplyd */}
              <h2>A House We Built Together</h2>
              <select
