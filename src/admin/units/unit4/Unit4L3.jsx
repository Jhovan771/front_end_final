...
import Sunny from "../../../assets/Unit1/Scrape.jpeg";
import found from "../../../assets/Unit1/Dodge.jpeg";
import thirsty from "../../../assets/Unit1/Sking.jpeg";
import water from "../../../assets/Unit1/Climbing.jpeg";
import Lessonbar2 from "./Unit4-Lessonbar/Lessonbar4";

const Unit4L3 = () => {
  const [wordData] = useState(["Scrape", "Dodge", "Skin", "Climbing"]);
        ...
        <div className='class-section-wrapper'>
          ...
          <div className='class-section-content'>
            <div className='title-voice-changer-control'>
              {/* wllplyd */}
              <h2>Every Time I Climb a Tree</h2>
              <select
