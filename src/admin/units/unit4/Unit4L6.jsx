...
import Sunny from "../../../assets/Unit1/Wrong.jpeg";
import found from "../../../assets/Unit1/Valentine.jpeg";
import thirsty from "../../../assets/Unit1/Grandmother.jpeg";
import water from "../../../assets/Unit1/Wrinkle.jpeg";
import Lessonbar2 from "./Unit4-Lessonbar/Lessonbar4";

const Unit4L6 = () => {
  const [wordData] = useState(["Wrong", "Valentine", "Grandmother", "Wrinkle"]);
        ...
        <div className='class-section-wrapper'>
          ...
          <div className='class-section-content'>
            <div className='title-voice-changer-control'>
              {/* wllplyd */}
              <h2>It is Never Wrong to Say I Love You</h2>
              <select
