...
import Sunny from "../../../assets/Unit1/Wonder.jpeg";
import found from "../../../assets/Unit1/Stream.jpeg";
import thirsty from "../../../assets/Unit1/Creature.jpeg";
import water from "../../../assets/Unit1/Realize.jpeg";
import Lessonbar2 from "./Unit4-Lessonbar/Lessonbar4";

const Unit4L1 = () => {
  const [wordData] = useState(["Wonder", "Stream", "Creature", "Realize"]);
        ...
        <div className='class-section-wrapper'>
          ...
          <div className='class-section-content'>
            <div className='title-voice-changer-control'>
              {/* wllplyd */}
              <h2>Glimpse of a Polluted Future</h2>
              <select
