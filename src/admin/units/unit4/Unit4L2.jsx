...
import Sunny from "../../../assets/Unit1/Night.jpeg";
import found from "../../../assets/Unit1/Light.jpeg";
import thirsty from "../../../assets/Unit1/Might.jpeg";
import water from "../../../assets/Unit1/Sight.jpeg";
import Lessonbar2 from "./Unit4-Lessonbar/Lessonbar4";

const Unit4L2 = () => {
  const [wordData] = useState(["Night", "Light", "Might", "Sight"]);
        ...
        <div className='class-section-wrapper'>
          ...
          <div className='class-section-content'>
            <div className='title-voice-changer-control'>
              {/* wllplyd */}
              <h2>A Bright Night for Little Might</h2>
              <select
