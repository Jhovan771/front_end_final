...
const L4Test1 = () => {
  const wordData = ["Jump", "Cop", "Pot", "Hot"];
  ...
  let textToRead =
    "This is Mox, the Fox. \n Mox can jump. \n Mox can hop into a box. \n Mox hops on Rox. \n Rox does not like it. \n She is Mad. \n Mox hops into a cop. \n He is mad. \n Mox hops into a pot. \n Oh! Oh! It is hot. \n Now Max, the Fox, is sad.";
  ...
  useEffect(() => {
    ...
    sessionStorage.setItem("act-num", "4");
    sessionStorage.setItem("title", "Mox the Fox");
  }, []);
        ...
        <div className='class-section-wrapper'>
          ...
          <div className='class-section-content'>
            <div className='class-test-main-wrapper'>
              <div className='class-test-box-1'>Mox, the Fox</div>
              <div className='class-test-box-2'>
                This is Mox, the Fox. Mox can{" "}
                <span className='words-controller'>jump</span>. Mox can hop into
                a box. Mox hops on Rox. Rox does not like it. She is Mad. Mox
                hops into a <span className='words-controller'>cop</span>. He is
                mad. Mox hops into a{" "}
                <span className='words-controller'>pot</span>. Oh! Oh! It is{" "}
                <span className='words-controller'>hot</span>. Now Max, the Fox,
                is sad.
              </div>
