...
const UT3L7 = () => {
  const wordData = ["Mouse", "Ground", "Cross", "Frowns"];
  ...
  // wllplyd
  let textToRead =
    "The Mouse and the Sow walked on the ground. The two friends found a pail of pig food. The Mouse shouted, 'It tastes good. Come on, Sow, let us run on the ground.' But there was a bog on the ground. And now the Mouse and the Sow must hop to cross the bog on the ground. But the sow can't hop on the ground. 'Hop with me, Sow' Mouse said. 'I can't hop,' The Sow said. Now the Sow frowns with a pouting mouth As the Mouse eats a mouthful.";
        ...
        <div className='class-section-wrapper'>
          ...
          <div className='class-section-content'>
            <div className='class-test-main-wrapper'>
              {/* wllplyd */}
              <div className='class-test-box-1'>The Mouse and the Sow</div>
              <div className='class-test-box-2'>
                The <span className='words-controller'>Mouse</span> and the Sow
                walked on the <span className='words-controller'>ground</span>.
                The two friends found a pail of pig food. The{" "}
                <span className='words-controller'>Mouse</span> shouted, 'It
                tastes good. Come on, Sow, let us run on the{" "}
                <span className='words-controller'>ground</span>.' But there was
                a bog on the <span className='words-controller'>ground</span>.
                And now the <span className='words-controller'>Mouse</span> and
                the Sow must hop to{" "}
                <span className='words-controller'>cross</span> the bog on the{" "}
                <span className='words-controller'>ground</span>. But the sow
                can't hop on the{" "}
                <span className='words-controller'>ground</span>. 'Hop with me,
                Sow' <span className='words-controller'>Mouse</span> said. 'I
                can't hop,' The Sow said. Now the Sow{" "}
                <span className='words-controller'>frowns</span> with a pouting
                mouth As the <span className='words-controller'>Mouse</span>{" "}
                eats a mouthful.
              </div>
