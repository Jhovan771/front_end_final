...
const UT3L1 = () => {
  const wordData = ["Father", "Gentle", "Bundle", "Failed"];
  ...
  // wllplyd
  let textToRead =
    "A long time ago, there was a father who had three sons. He felt sad because his sons always quarrelled among themselves. He tried to solve their fights with his gentle words but he failed. One day, he told his three sons, 'Bring me a bundle of sticks.' He placed the bundle of sticks in the hands of his first son and ordered him, 'Break it!' The first son tried with all his strenght but was not able to do it. 'Now son, break the bundle of sticks,' he ordered his second son. The second son tried but he, too failed. So, the last son was also asked to break the bundle of sticks. He tried but failed also like his brothers. 'I'm sorry, father. I couldn't break the bundle of sticks,' he said.";
        ...
        <div className='class-section-wrapper'>
          ...
          <div className='class-section-content'>
            <div className='class-test-main-wrapper'>
              {/* wllplyd */}
              <div className='class-test-box-1'>The Bundle of Sticks</div>
              <div className='class-test-box-2'>
                A long time ago, there was a{" "}
                <span className='words-controller'>father</span> who had three
                sons. He felt sad because his sons always quarrelled among
                themselves. He tried to solve their fights with his{" "}
                <span className='words-controller'>gentle</span> words but he{" "}
                <span className='words-controller'>failed</span>. One day, he
                told his three sons, 'Bring me a{" "}
                <span className='words-controller'>bundle</span> of sticks.' He
                placed the <span className='words-controller'>bundle</span> of
                sticks in the hands of his first son and ordered him, 'Break
                it!' The first son tried with all his strenght but was not able
                to do it. 'Now son, break the{" "}
                <span className='words-controller'>bundle</span> of sticks,' he
                ordered his second son. The second son tried but he, too{" "}
                <span className='words-controller'>failed</span>. So, the last
                son was also asked to break the{" "}
                <span className='words-controller'>bundle</span> of sticks. He
                tried but <span className='words-controller'>failed</span> also
                like his brothers. 'I'm sorry,{" "}
                <span className='words-controller'>father</span>. I couldn't
                break the <span className='words-controller'>bundle</span> of
                sticks,' he said.
              </div>
