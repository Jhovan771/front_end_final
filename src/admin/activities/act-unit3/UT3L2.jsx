...
const UT3L2 = () => {
  const wordData = ["Built", "Nailed", "Boards", "Stand"];
  ...
  // wllplyd
  let textToRead =
    "Out house is a house. We built together. We have laid every brick one by one. We have nailed every board, one blow at a time. Our house is a house. We built it together. Not every board is perfect, some are not even straight. Some walls are built in the wrong place. We must carefully remove those bastards. We must carefully remove those walls. We must rebuild them in the right place. We must replace each board one by one. Until the holes are filled. Until all the walls are in the right place. When we have finished we can stand back and say 'This is our house, A house we built together!'";
        ...
        <div className='class-section-wrapper'>
          ...
          <div className='class-section-content'>
            <div className='class-test-main-wrapper'>
              {/* wllplyd */}
              <div className='class-test-box-1'>A House We Built Together</div>
              <div className='class-test-box-2'>
                Our <span className='words-controller'>house</span> is a{" "}
                <span className='words-controller'>house</span>. We built
                together. We have laid every brick one by one. We have nailed
                every board, one blow at a time. Our{" "}
                <span className='words-controller'>house</span> is a{" "}
                <span className='words-controller'>house</span>. We built it
                together. Not every board is perfect, some are not even
                straight. Some walls are built in the wrong place. We must
                carefully remove those bastards. We must carefully remove those
                walls. We must rebuild them in the right place. We must replace
                each <span className='words-controller'>board</span> one by one.
                Until the holes are filled. Until all the walls are in the right
                place. When we have finished we can stand back and say 'This is
                our <span className='words-controller'>house</span>, A{" "}
                <span className='words-controller'>house</span> we built
                together!'
              </div>
