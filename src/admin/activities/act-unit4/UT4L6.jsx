...
const UT4L6 = () => {
  const wordData = ["Wrong", "Valentine", "Grandmother", "Wrinkle"];
  ...
  // wllplyd
  let textToRead =
    "It is never wrong! I just really love her I want to wrap a gift or write a letter. I want to give a Valentine wreath or a wren or whatever. It is never wrong! I want to tell grandmother My love for her is deeper than the wrinkle I want to tell her I love her. It is never wrong to say I love her. It is never wrong to say I love you grandmother.";
          ...
          <div className='class-section-content'>
            <div className='class-test-main-wrapper'>
              ...
              <div className='class-test-box-2'>
                It is never <span className='words-controller'>wrong</span>! I
                just really love her I want to wrap a gift or write a letter. I
                want to give a{" "}
                <span className='words-controller'>Valentine</span> wreath or a
                wren or whatever. It is never{" "}
                <span className='words-controller'>wrong</span>! I want to tell{" "}
                <span className='words-controller'>grandmother</span> My love
                for her is deeper than the{" "}
                <span className='words-controller'>wrinkle</span> I want to tell
                her I love her. It is never{" "}
                <span className='words-controller'>wrong</span> to say I love
                her. It is never <span className='words-controller'>wrong</span>{" "}
                to say I love you{" "}
                <span className='words-controller'>grandmother</span>.
              </div>
