...
const UT4L4 = () => {
  const wordData = ["Mother", "Mountain", "Garbage", "Pollution"];
  ...
  // wllplyd
  let textToRead =
    "Before, Mother Earth was beautiful. With here rivers, mountains, and seas; Seas and rivers that were fish full and mountains have strong and tall trees. Now, Mother Earth is ugly. To us, she is dying slowly. Garbage and pollution are everywhere. But only a few people are aware.";
        ...
        <div className='class-section-wrapper'>
          ...
          <div className='class-section-content'>
            <div className='class-test-main-wrapper'>
              {/* wllplyd */}
              <div className='class-test-box-1'>Mother Earth</div>
              <div className='class-test-box-2'>
                Before, <span className='words-controller'>Mother</span> Earth
                was beautiful. With here rivers,{" "}
                <span className='words-controller'>mountains</span>, and seas;
                Seas and rivers that were fish full and{" "}
                <span className='words-controller'>mountains</span> have strong
                and tall trees. Now,{" "}
                <span className='words-controller'>Mother</span> Earth is ugly.
                To us, she is dying slowly.{" "}
                <span className='words-controller'>Garbage</span> and{" "}
                <span className='words-controller'>pollution</span> are
                everywhere. But only a few people are aware.
              </div>
