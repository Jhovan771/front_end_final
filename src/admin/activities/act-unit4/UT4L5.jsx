...
const UT4L5 = () => {
  const wordData = ["Future", "Nature", "Sunset", "Quickly"];
  ...
  // wllplyd
  let textToRead =
    "What does the future hold for us? Smog filled skies and poison cars, and broken land with useless dust and nature's beauty behind bars. Can I ever show my children, the beauty of a sunset at the end of the day? Can I walk into a forest, and sorround myself with tress, yet know that it will remain, for me to visit as I wish. I know that I can today do all things I've said, but when today is yesterday, will all these things be dead? This problem is huge. As we slowly see, we must fix it quickly, in words and thoughts and deeds.";
        ...
        <div className='class-section-wrapper'>
          ...
          <div className='class-section-content'>
            <div className='class-test-main-wrapper'>
              {/* wllplyd */}
              <div className='class-test-box-1'>The Future</div>
              <div className='class-test-box-2'>
                What does the <span className='words-controller'>future</span>{" "}
                hold for us? Smog filled skies and poison cars, and broken land
                with useless dust and{" "}
                <span className='words-controller'>nature</span>'s beauty behind
                bars. Can I ever show my children, the beauty of a{" "}
                <span className='words-controller'>sunset</span> at the end of
                the day? Can I walk into a forest, and sorround myself with
                tress, yet know that it will remain, for me to visit as I wish.
                I know that I can today do all things I've said, but when today
                is yesterday, will all these things be dead? This problem is
                huge. As we slowly see, we must fix it{" "}
                <span className='words-controller'>quickly</span>, in words and
                thoughts and deeds.
              </div>
