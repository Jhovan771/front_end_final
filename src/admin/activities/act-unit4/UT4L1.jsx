...
const UT4L1 = () => {
  const wordData = ["Wonder", "Stream", "Creature", "Realize"];
          ...
          <div className='class-section-content'>
            <div className='class-test-main-wrapper'>
              ...
              <div className='class-test-box-2'>
                Where are the birds that used to dot the sky? They're not here
                anymore, and I have to{" "}
                <span className='words-controller'>wonder</span> why. Where are
                the fish that used to swim in this{" "}
                <span className='words-controller'>stream</span>? I can't see
                them anymore. What does that mean? Where are the frogs that used
                to croak around this lake? I can't hear them anymore. There must
                be some <span className='words-controller'>mistake</span>. I
                wish there was a clock whose hands I could rewind. We might have
                saved these <span className='words-controller'>creatures</span>{" "}
                if we'd just had more time. Time to make people see how we are
                damaging our Earth. Time to{" "}
                <span className='words-controller'>realize</span> what it all
                was truly worth. But the animals are disappearing at an alarming
                rate. If we don't finally band together, it may really be too
                late.
              </div>
