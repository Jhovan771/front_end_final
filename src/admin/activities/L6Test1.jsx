...
const L6Test1 = () => {
  const wordData = ["Middle", "Jug ", "Mug", "Bug"];
  ...
  let textToRead =
    "There's a jug in the middle of a rug. There's a jug in the middle of a rug. There's a jug, there's a jug. There's a jug in the middle of a rug. There's a mug in the jug in the middle of a rug. There's a mug in the jug in the middle of a rug. There's a mug, there's a mug. There's a mug in the jug in the middle of a rug.";
  ...
  useEffect(() => {
    ...
    sessionStorage.setItem("act-num", "6");
    sessionStorage.setItem("title", "A Jug in the Middle of the Rug");
  }, []);
          ...
          <div className='class-section-content'>
            <div className='class-test-main-wrapper'>
              ...
              <div className='class-test-box-2'>
                There's a <span className='words-controller'>jug</span> in the{" "}
                <span className='words-controller'>middle</span> of a rug.
                There's a <span className='words-controller'>jug</span> in the{" "}
                <span className='words-controller'>middle</span> of a rug.
                There's a <span className='words-controller'>jug</span>, there's
                a <span className='words-controller'>jug</span>. There's a{" "}
                <span className='words-controller'>jug</span> in the{" "}
                <span className='words-controller'>middle</span> of a rug.
                There's a <span className='words-controller'>mug</span> in the{" "}
                <span className='words-controller'>jug</span> in the{" "}
                <span className='words-controller'>middle</span> of a rug.
                There's a <span className='words-controller'>mug</span> in the{" "}
                <span className='words-controller'>jug</span> in the{" "}
                <span className='words-controller'>middle</span> of a rug.
                There's a <span className='words-controller'>mug</span>, there's
                a <span className='words-controller'>mug</span>. There's a{" "}
                <span className='words-controller'>mug</span> in the{" "}
                <span className='words-controller'>jug</span> in the{" "}
                <span className='words-controller'>middle</span> of a rug.
              </div>
