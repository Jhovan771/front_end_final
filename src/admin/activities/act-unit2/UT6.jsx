...
const UT6 = () => {
  const wordData = ["Huge", "Familiar", "Pinched", "Grabbed"];
  ...
  useEffect(() => {
    ...
    sessionStorage.setItem("title", "The Big Day");
  }, []);
          ...
          <div className='class-section-content'>
            <div className='class-test-main-wrapper'>
              ...
              <div className='class-test-box-2'>
                ...
                <span className='words-controller'>huge</span> bags. He looked
                taller. He seemed very{" "}
                <span className='words-controller'>familiar</span>. Everyone
                around started to clap their hands. Everybody was happy and
                excited seeing the man. The man smiled at Ana. She{" "}
                <span className='words-controller'>pinched</span> herself, not
                believing what she saw. Teary-eyed, the man walked toward Ana
                who stood still. He{" "}
                <span className='words-controller'>grabbed</span> Ana's hands
