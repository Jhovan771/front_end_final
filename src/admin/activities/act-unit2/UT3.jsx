...
const UT3 = () => {
  const wordData = ["Cake", "Bake", "Add", "Smile"];
  ...
  let textToRead =
    "Jake bakes a cake. He takes the cake to kate. 'Did you bake tis cake Jake?' Kate asks. 'Yes,' he says. Together, Kate and Jake eat the cake. 'Oh, thank you, Jake,' Kate adds. 'It is your birthday,' Jake smiles.";
  ...
  useEffect(() => {
    ...
    sessionStorage.setItem("act-num", "3");
    sessionStorage.setItem("title", "Cake for Kate");
  }, []);
        ...
        <div className='class-section-wrapper'>
          ...
          <div className='class-section-content'>
            <div className='class-test-main-wrapper'>
              <div className='class-test-box-1'>Cake for Kate</div>
              <div className='class-test-box-2'>
                Jake <span className='words-controller'>bakes</span> a{" "}
                <span className='words-controller'>cake</span>. He takes the{" "}
                <span className='words-controller'>cake</span> to Kate. 'Did you{" "}
                <span className='words-controller'>bake</span> this{" "}
                <span className='words-controller'>cake</span> Jake?' Kate asks.
                'Yes,' he says. Together, Kate and Jake eat the{" "}
                <span className='words-controller'>cake</span>. 'Oh, thank you,
                Jake,' Kate <span className='words-controller'>adds</span>. 'It
                is your birthday,' Jake{" "}
                <span className='words-controller'>smiles</span>.
              </div>
