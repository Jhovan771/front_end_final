        ...
        <div className='class-section-wrapper'>
          ...
          <div className='class-section-content'>
            <div className='class-test-main-wrapper'>
              {/* wllplyd */}
              <div className='class-test-box-1'>Jake's New Cape</div>
              <div className='class-test-box-2'>
                Jake has a new <span className='words-controller'>cape</span>.
                Kate's pet <span className='words-controller'>male</span>{" "}
                <span className='words-controller'>ape</span> takes Jake's new{" "}
                <span className='words-controller'>cape</span>. Kate makes her
                pet <span className='words-controller'>ape</span> Give it{" "}
                <span className='words-controller'>back</span> to Jake. Jake
                thanks Kate.
              </div>
