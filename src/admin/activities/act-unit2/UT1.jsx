...
const UT1 = () => {
  const wordData = ["Branch", "Watch", "Change", "Honest"];
  ...
  let textToRead =
    "Chad has so much cash now. The cash came from Ninong Charles. He counted it seated on the branch of a tree. And he shouted, 'I'm very rich! Yippee!'. Chad has a new watch now. He bought a sketch pad too. He went to watch a movie. Chad is so cheerful and happy. Chad ordered chocolate and chips. 'My change is too much,' said Chad. He checked and returned the extra money. 'That's great! You're an honest kid!' said his mommy.";
  ...
  const recordScore = () => {
    ...
    if (currentAttempts >= 3 || score >= 4) {
      ...
      const newScore = score + 1; // Incrementing the score
  ...
  useEffect(() => {
    ...
    sessionStorage.setItem("title", "Chad the Honest Kid");
  }, []);
